...
//create your first component     va despues de cardsContainer  {cardInfo.map((infoCard) => { return <Card {...infoCard} key = {infoCard.id}/>;})} 
const Home = () => {
	return (
		<>
			<Navbar />
			...
			<div class="card-footer text-light text-center bg-dark mt-3 mb-1 pt-3 pb-3">
...
/*
forma en que hicimos el el proyecto inicialmente, esto iria en lugar del {cardInfo.map
